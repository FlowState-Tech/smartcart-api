package com.smartcart.iam.application.internal.queryservices;

import com.smartcart.iam.domain.model.entities.Role;
import com.smartcart.iam.domain.model.queries.GetAllRolesQuery;
import com.smartcart.iam.domain.model.queries.GetRoleByNameQuery;
import com.smartcart.iam.domain.services.RoleQueryService;
import com.smartcart.iam.infrastructure.persistence.jpa.repositories.RoleRepository;
