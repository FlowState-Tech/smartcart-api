package com.smartcart.iam.infrastructure.authorization.sfs.configuration;

import com.smartcart.iam.infrastructure.authorization.sfs.pipeline.BearerAuthorizationRequestFilter;
import com.smartcart.iam.infrastructure.hashing.bcrypt.BCryptHashingService;
import com.smartcart.iam.infrastructure.tokens.jwt.BearerTokenService;
        ...
        http.csrf(csrfConfigurer -> csrfConfigurer.disable())
                ...
                .authorizeHttpRequests(authorizeRequests -> authorizeRequests
                        ...
                        .requestMatchers(
                                ...
                                "/swagger-resources/**",
                                "/webjars/**",
                                "/api/v1/shopping-carts/**").permitAll()
